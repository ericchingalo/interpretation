...
FilterPipe, 
TruncatePipe, 
AutosizeDirective, VisualizationCardComponent, DropdownDirective, InterpretationLoaderComponent, TopInterpretationsComponent, TopAuthorsComponent, TopCommentatorsComponent, 
], 
imports:[
